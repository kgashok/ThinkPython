...
class uxbar(Base.Command):
    pass


class uybar(Base.Command):
    pass


class unhat(Base.Command):
    pass


class ule(Base.Command):
    pass


class minus(Base.Command):
    pass


class lowast(Base.Command):
    pass


class Erdos(Base.Command):
    pass
